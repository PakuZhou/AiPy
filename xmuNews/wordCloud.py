...
import numpy as np
#%matplotlib inline  # jupyter中要加这句，显示图片
import jieba
import json
import random
...
# 连接数据库
import MySQLdb
db = MySQLdb.connect(host="localhost", user="root" ,passwd="123456",db="newwyy",charset="utf8")
cursor = db.cursor()
...
# 设置字体,如果是windows系统，请自行下载字体文件替换
font = '/Users/weiweiwang/code/newwyy/DroidSansFallbackFull.ttf'
# 生成词云
